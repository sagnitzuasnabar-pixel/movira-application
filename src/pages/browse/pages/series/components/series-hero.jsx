...
export function SeriesHero({ show }) {
  const navigate = useNavigate();
  
  function handleReproducir() {
    navigate(`/browse/serie/${show.id}`)
  }
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${IMAGE_BASE_URL}${show.backdrop_path})` }}
    >
      ...
      <div className="absolute top-24 left-4 md:left-12 z-10">
        <h1 className="text-white text-4xl md:text-5xl font-bold">Series</h1>
      </div>

      <div className="relative z-10 max-w-xl">
        <p className="text-white text-sm font-semibold mb-2">Serie de Movira</p>
