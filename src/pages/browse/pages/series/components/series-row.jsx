...
import { useGetSeriesByGenre } from '../hooks/use-get-series-by-genre'
import { useSliderNavigation } from '../../../../../hooks/use-slider-navigation'

const IMAGE_BASE_URL_SMALL = 'https://image.tmdb.org/t/p/w500'

export function SeriesRow({ title, genreId }) {
  const { series, loading, error } = useGetSeriesByGenre(genreId)
