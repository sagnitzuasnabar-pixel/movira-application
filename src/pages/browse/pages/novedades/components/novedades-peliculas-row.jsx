...
import { useGetNovedadesPeliculas } from '../hooks/use-get-novedades-peliculas'
import { IMAGE_BASE_URL_SMALL } from '../../../../../services/get-trending'
import { useSliderNavigation } from '../../../../../hooks/use-slider-navigation'

export function NovedadesPeliculasRow() {
  const { peliculas, loading, error } = useGetNovedadesPeliculas()
